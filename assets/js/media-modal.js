	...
	w.imagify.modal = {
		...
		init: function () {
			...
			if ($processing.length) {
				...
				$processing
					.closest(".imagify-data-actions-container")
					.each(function () {
						var $this = $(this),
		...
		addToImagifybeat: function (e, data) {
			...
			$containers.each(function () {
				...
				data[w.imagifyModal.imagifybeatID][context] =
					data[w.imagifyModal.imagifybeatID][context] || {};
		...
		processImagifybeat: function (e, data) {
			...
			$.each(
				data[w.imagifyModal.imagifybeatID],
				function (contextId, htmlContent) {
					var context, id;
		...
		openSlide: function ($containers) {
			$containers.each(function () {
				var $container = $(this),
					text = $container
						.find(".imagify-datas-more-action a")
						.data("close");
		...
		getContainers: function (context, id) {
			return $(
				'.imagify-data-actions-container[data-id="' +
					id +
					'"][data-context="' +
					context +
					'"]'
