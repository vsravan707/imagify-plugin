!(function (e) {
		...
		if (c)
			for (; u--; )
				if ((o = c[(i = t[u])]))
					for (a = o.length; a--; )
						o[a][0] === n &&
							(e.removeEventListener(i, o[a][1]), o.splice(a, 1));
	}
	function l(e, t, n) {
	...
	function j(e, t) {
		var n = t.target,
			i = t.event,
			o = t.timer;
		X(e.changedTouches, i.identifier) &&
			((e = t),
	...
	function A(e) {
		...
		e.handler = function (e) {
			for (var t, n = o.length; n--; ) e[(t = o[n])] = e.originalEvent[t];
			...
			n[e.target.tagName.toLowerCase()] ||
				((e = {
					...
					touchmove: function (e, t) {
						var n;
						(n = Y((e = e), (t = t))) && S(e, t, n, b);
					},
					touchend: function (e, t) {
						((t = t), X(e.changedTouches, t.identifier) && b(t));
					},
				}),
