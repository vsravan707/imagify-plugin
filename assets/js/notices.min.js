(((a) => {
	a(document).on("click", ".imagify-notice-dismiss", function (i) {
		var e = a(this),
			t = e.parents(
		...
		(i.preventDefault(),
			...
			a.get(e.replace("admin-post.php", "admin-ajax.php")));
	});
})(jQuery, (document, window)),
	((a, n) => {
		(a("#imagify-signup").on("click.imagify", function (i) {
			(i.preventDefault(),
				swal({
					title: imagifyNotices.labels.signupTitle,
					html: imagifyNotices.labels.signupText,
					confirmButtonText:
						imagifyNotices.labels.signupConfirmButtonText,
					input: "email",
					padding: 0,
					showLoaderOnConfirm: !0,
					customClass:
						"imagify-sweet-alert imagify-sweet-alert-signup",
					inputValidator: function (t) {
						return new Promise(function (i, e) {
							"" !== a.trim(t) && t
								? i()
								: e(
										imagifyNotices.labels
											.signupErrorEmptyEmail,
									);
						});
					},
							...
							setTimeout(function () {
								a.get(
									ajaxurl +
										...
										i +
										"&imagifysignupnonce=" +
										a("#imagifysignupnonce").val(),
								).done(function (i) {
									i.success ? e() : t(i.data);
								});
							}, 2e3);
						});
					},
			...
			a("#imagify-save-api-key").on("click.imagify", function (i) {
				(i.preventDefault(),
					swal({
						...
						inputValidator: function (t) {
							return new Promise(function (i, e) {
								"" !== a.trim(t) && t
									? i()
									: e(imagifyNotices.labels.ApiKeyErrorEmpty);
							});
						},
						preConfirm: function (i) {
							return new Promise(function (e, t) {
