	...
	var e = {
		...
		l = function (e) {
			if ("undefined" != typeof document) {
				...
				(o ||
					(console.warn(
						"SweetAlert2: Can't find the target \"" +
							e.target +
							'"',
					),
					(o = document.body)),
		...
		U = function (t) {
			...
			if (t.type) {
				...
				if (!N)
					return (
						console.error(
							"SweetAlert2: Unknown alert type: " + t.type,
						),
						!1
					);
