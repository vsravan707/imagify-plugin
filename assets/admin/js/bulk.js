	...
	[350],
	{
		"./bulk.js": () => {
			((window.imagify = window.imagify || {}),
				(function (i, a) {
					var e = i.propHooks.checked;
					((i.propHooks.checked = {
						set: function (t, s, l) {
							var o;
							return (
								(o = a === e ? (t[l] = s) : e(t, s, l)),
								i(t).trigger("change.imagify"),
								o
							);
						},
					}),
						(i.fn.imagifyHide = function (e, t) {
							return (
								e && e > 0
									? this.hide(e, function () {
											(i(this)
												.addClass("hidden")
												.css("display", ""),
												a !== t && t());
										})
									: (this.addClass("hidden"), a !== t && t()),
								this.attr("aria-hidden", "true")
							);
						}),
						(i.fn.imagifyShow = function (e, t) {
							return (
								a !== t && t(),
								e && e > 0
					...
					((e.imagify.bulk = {
						charts: {
							overview: {
								...
								data: {
									labels: [
										imagifyBulk.labels.overviewChartLabels
											.unoptimized,
										imagifyBulk.labels.overviewChartLabels
											.optimized,
										imagifyBulk.labels.overviewChartLabels
							...
							files: { donuts: {} },
							share: { canvas: !1, donut: !1 },
						},
						folderTypesQueue: [],
						status: {},
						displayedWaitMessage: !1,
						hasMultipleRows: !0,
						processIsStopped: !1,
						...
						init: function () {
							...
							(this.drawOverviewChart(),
								...
								imagifyBulk.optimizing &&
									...
									e.imagify.beat.disableSuspend()));
						},
						getAjaxUrl: function (i, a) {
							var t =
								ajaxurl +
								e.imagify.concat +
								"_wpnonce=" +
								imagifyBulk.ajaxNonce +
								"&action=" +
								imagifyBulk.ajaxActions[i];
							return (
								a &&
									a.context &&
									(t += "&context=" + a.context),
						...
						closeLevelSelector: function (i, a) {
							i &&
								i.length &&
								(t !== a && a > 0
						...
						stopProcess: function (a, t) {
							((e.imagify.bulk.processIsStopped = !0),
								(e.imagify.bulk.status[t.groupID] = {
									isError: !0,
									id: a,
								}),
								i(e).trigger("queueEmpty.imagify"));
						},
						hasBlockingError: function (a) {
							return (
								(a = t !== a && a),
								imagifyBulk.curlMissing
									? (a &&
											e.imagify.bulk.displayError({
												html: imagifyBulk.labels
													.curlMissing,
											}),
										(e.imagify.bulk.processIsStopped = !0),
										!0)
									: imagifyBulk.editorMissing
										? (a &&
												e.imagify.bulk.displayError({
													html: imagifyBulk.labels
														.editorMissing,
											...
											: imagifyBulk.apiDown
												? (a &&
													...
													(e.imagify.bulk.processIsStopped =
														!0),
													!0)
												: imagifyBulk.keyIsValid
													? !!imagifyBulk.isOverQuota &&
														(a &&
															e.imagify.bulk.displayError(
																{
																	title: imagifyBulk
						...
						displayError: function (a, e, t) {
							...
							(i.isPlainObject(a)
								...
								swal(t).catch(swal.noop));
						},
						displayShareBox: function () {
							var a, t;
							if (
								!this.globalGain ||
								this.folderTypesQueue.length
							)
								return (
									(this.globalOptimizedCount = 0),
									(this.globalGain = 0),
									(this.globalOriginalSize = 0),
									void (this.globalOptimizedSize = 0)
								);
							((t =
								this.globalOriginalSize -
								this.globalOptimizedSize),
								(a = i(".imagify-row-complete"))
									.find(".imagify-ac-rt-total-images")
									.html(this.globalOptimizedCount),
								a
									.find(".imagify-ac-rt-total-gain")
									.html(e.imagify.humanSize(t, 1)),
								a
									.find(".imagify-ac-rt-total-original")
									.html(
										e.imagify.humanSize(
											this.globalOriginalSize,
											1,
						...
						updateStats: function (a) {
							...
							a &&
								i.isPlainObject(a) &&
								((e.imagify.bulk.charts.overview.donut.data &&
									((t =
										e.imagify.bulk.charts.overview.donut
											.data.datasets[0].data),
									a.unoptimized_attachments === t[0] &&
										a.optimized_attachments === t[1] &&
										a.errors_attachments === t[2])) ||
									((a.unconsumed_quota =
						...
						openSelectorFromButton: function (a) {
							...
							(a.stopPropagation(),
								i(".imagify-selector-list")
									.not(e)
									.attr("aria-hidden", "true"),
								e
									.attr("aria-hidden", "false")
									.find(":checked")
									.trigger("focus.imagify"));
						},
						syncSelectorFromRadio: function () {
							var a = i(this).closest(".imagify-selector-choice");
							(a
								.addClass("imagify-selector-current-value")
								.attr("aria-current", "true")
								.siblings(".imagify-selector-choice")
								.removeClass("imagify-selector-current-value")
						...
						toggleOptimizationButton: function () {
							e.imagify.bulk.hasMultipleRows || this.checked
								? imagifyBulk.optimizing
								...
								(i(
									...
									(e.imagify.bulk.hasBlockingError(!0) ||
										((a = i("#tmpl-imagify-bulk-infos"))
											.length
											? swal({
													title: imagifyBulk.labels
														.bulkInfoTitle,
													html: a.html(),
													type: "",
													customClass:
														"imagify-sweet-alert imagify-swal-has-subtitle imagify-before-bulk-infos",
													showCancelButton: !0,
													padding: 0,
													width: 554,
													confirmButtonText:
						...
						launchAllProcesses: function () {
							...
							(i("#imagify-bulk-action")
								...
								.find(".dashicons")
								.addClass("rotate"),
								i(".imagify-row-complete").imagifyHide(
									200,
									function () {
								...
								(this.status = {}),
								(this.displayedWaitMessage = !1),
								(this.processIsStopped = !1),
								(this.globalOptimizedCount = 0),
								(this.globalGain = 0),
								(this.globalOriginalSize = 0),
								(this.globalOptimizedSize = 0),
								i(
									...
									(e.imagify.bulk.folderTypesQueue.push({
										groupID: s,
										context: l,
										level: t === o ? -1 : parseInt(o, 10),
									}),
										(e.imagify.bulk.status[s] = {
											isError: !1,
											id: "waiting",
										}));
								}),
								e.imagify.beat.interval(15),
								e.imagify.beat.disableSuspend(),
								a.trigger("processQueue.imagify"));
						},
						processQueue: function () {
							var a, t, s, l;
							e.imagify.bulk.processIsStopped ||
								(e.imagify.bulk.displayedWaitMessage ||
									(swal({
									...
									(e.imagify.bulk.displayedWaitMessage = !0)),
								e.imagify.bulk.folderTypesQueue.forEach(
									function (o) {
										i.get(
											e.imagify.bulk.getAjaxUrl(
												"bulkProcess",
												...
												(swal.close(),
													(n =
														r.data && r.data.message
															? r.data.message
															: imagifyBulk.ajaxErrorText),
													r.success &&
													r.data &&
													(i.isPlainObject(r.data) ||
														i.isArray(r.data))
														? r.success &&
															((a = i(
																"#cb-select-" +
						...
						queueEmpty: function () {
							var a = i(".imagify-bulk-table"),
								t = {},
								s = !1,
								l = !0,
								o = "";
							(e.imagify.beat.resetInterval(),
								e.imagify.beat.enableSuspend(),
								(e.imagify.bulk.folderTypesQueue = []),
								e.imagify.bulk.displayShareBox(),
								imagifyBulk.imagifybeatIDs.stats ||
									i
										.get(
											e.imagify.bulk.getAjaxUrl(
												...
												: "over-quota" === s
													...
													: ("get-unoptimized-images" !==
														...
														(t = {
															title: imagifyBulk
																.labels
																.getUnoptimizedImagesErrorTitle,
															html: imagifyBulk
																.labels
																.getUnoptimizedImagesErrorText,
															type: "info",
														}),
											e.imagify.bulk.displayError(t))
										: l &&
											((o =
								...
								a
									...
									.text("0%"),
								a
									.find(".imagify-cell-checkbox-loader")
									.each(function () {
										i(this)
											.addClass("hidden")
											.attr("aria-hidden", "true");
								...
								a
									.find(".imagify-cell-checkbox-box")
									.each(function () {
										i(this)
											.removeClass("hidden")
											.attr("aria-hidden", "false");
						...
						processQueueImagifybeat: function (a, t) {
							var s, l, o;
							if (
								void 0 !== t[imagifyBulk.imagifybeatIDs.queue]
							) {
								if (
									(!1 !==
										(s =
											t[imagifyBulk.imagifybeatIDs.queue])
											.result &&
										((e.imagify.bulk.globalOriginalSize =
											s.result.original_size),
										(e.imagify.bulk.globalOptimizedSize =
											s.result.optimized_size),
										(e.imagify.bulk.globalOptimizedCount =
											s.result.total),
										(e.imagify.bulk.globalGain =
											(100 *
												e.imagify.bulk
													.globalOptimizedSize) /
											e.imagify.bulk.globalOriginalSize)),
								...
								((o = i(".imagify-row-progress"))
									...
									.find(".percent")
									.html(s.percentage + "%"),
									o.slideDown().attr("aria-hidden", "false"));
							}
						},
						addRequirementsImagifybeat: function (i, a) {
							a[imagifyBulk.imagifybeatIDs.requirements] = 1;
						},
						processRequirementsImagifybeat: function (i, a) {
							void 0 !==
								a[imagifyBulk.imagifybeatIDs.requirements] &&
								((a =
									a[imagifyBulk.imagifybeatIDs.requirements]),
								(imagifyBulk.curlMissing = a.curl_missing),
								(imagifyBulk.editorMissing = a.editor_missing),
								(imagifyBulk.extHttpBlocked =
									a.external_http_blocked),
								(imagifyBulk.apiDown = a.api_down),
								(imagifyBulk.keyIsValid = a.key_is_valid),
								(imagifyBulk.isOverQuota = a.is_over_quota));
						},
						drawOverviewChart: function (t) {
							var s, l;
							(this.charts.overview.canvas ||
								((this.charts.overview.canvas =
									a.getElementById("imagify-overview-chart")),
								this.charts.overview.canvas)) &&
								((t = t && i.isArray(t) ? t : []),
								this.charts.overview.donut
									? t.length &&
										(0 ===
											t.reduce(function (i, a) {
												return i + a;
											}, 0) && (t[0] = 1),
										(this.charts.overview.donut.data.datasets[0].data =
											t),
									...
									: ((this.charts.overview.data.datasets[0].data =
										...
										i.each(s.labels, function (i, a) {
											l +=
												'<li><span style="background-color:' +
												s.datasets[0].backgroundColor[
													i
												] +
												'"></span>' +
												a +
						...
						drawShareChart: function () {
							var t;
							if (
								this.charts.share.canvas ||
								((this.charts.share.canvas =
									a.getElementById("imagify-ac-chart")),
								this.charts.share.canvas)
							) {
								if (
									((t = parseInt(
									...
									return (
										(this.charts.share.donut.data.datasets[0].data[0] =
											t),
										(this.charts.share.donut.data.datasets[0].data[1] =
											100 - t),
										void this.charts.share.donut.update()
									);
								this.charts.share.donut = new e.imagify.Chart(
									this.charts.share.canvas,
									{
										type: "doughnut",
										data: {
						...
						imagifyBulk.isOverQuota &&
							e.imagify.bulk.displayError({
								...
								html: i("#tmpl-imagify-overquota-alert").html(),
								type: "info",
								customClass:
									"imagify-swal-has-subtitle imagify-swal-error-header",
								showConfirmButton: !1,
