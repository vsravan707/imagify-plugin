...
<div class="wrap imagify-settings imagify-bulk">
	...
	<div class="imagify-settings-section">
				...
				<div class="imagify-columns">
					<div class="imagify-col col-statistics">
						...
						<div class="imagify-bars">
							...
							<div class="right-outside-number imagify-bar-negative base-transparent">
							...
							<div class="right-outside-number imagify-bar-primary base-transparent">
					...
					<div class="imagify-col col-chart">
						...
						<p class="imagify-clear imagify-global-optim-phrase">
							<?php
							printf(
		...
		<div class="imagify-flex imagify-bulk-submit imagify-vcenter">
