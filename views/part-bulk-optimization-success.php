...
<div class="hidden imagify-row-complete" aria-hidden="true">
	<div class="imagify-all-complete">
		...
		<div class="imagify-ac-spread-word">
			...
			<p>
				...
				?>
				<br>
				<a class="stars" aria-hidden="true" href="<?php echo esc_url(imagify_get_external_url('rate')); ?>" target="_blank"><?php echo str_repeat('<span class="dashicons dashicons-star-empty"></span>', 5); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
																																	?></a>
			</p>
		</div>
