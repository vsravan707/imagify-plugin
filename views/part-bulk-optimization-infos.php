...
<div class="imagify-swal-content">
	<ul class="imagify-list-infos">
		<li>
			<span class="imagify-info-icon"><svg width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
					<g fill="#40b1d0" fill-rule="nonzero">
						<path d="m18 36c-9.925 0-18-8.07-18-18 0-9.925 8.07-18 18-18 9.925 0 18 8.07 18 18 0 9.925-8.07 18-18 18m0-34.435c-9.06 0-16.435 7.372-16.435 16.435 0 9.06 7.372 16.435 16.435 16.435 9.06 0 16.435-7.372 16.435-16.435 0-9.06-7.372-16.435-16.435-16.435" />
						<path d="m27.391 18.783l-9.391 0c-.432 0-.783-.351-.783-.783l0-12.522c0-.432.351-.783.783-.783.432 0 .783.351.783.783l0 11.739 8.609 0c.432 0 .783.351.783.783 0 .432-.351.783-.783.783" />
					</g>
				</svg></span>
			<span>
				<?php
				...
				if (! empty($data['library']) && get_transient('imagify_large_library')) {
					printf(
						...
						esc_html(number_format_i18n(imagify_get_unoptimized_attachment_limit()))
					);
				}
				?>
			</span>
