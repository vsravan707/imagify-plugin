		...
		<div id="imagify-custom-folders" class="hide-if-no-js imagify-mt2">
			...
			<?php if ($themes) { ?>
				<div class="imagify-folder-themes-suggestion">
					<div class="imagify-flex imagify-fts-header imagify-vcenter">
			...
			<p class="imagify-flex imagify-kindof-title imagify-vcenter">
			...
			<p class="hidden imagify-success"><?php esc_html_e('You changed your custom folder settings, don\'t forget to save your changes!', 'imagify'); ?></p>
